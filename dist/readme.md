...
### Issue: "Error merging audio and video"
**Solution:** This should be fixed ffmpeg exe download
- Download exe file at https://ffmpeg.org/download.html
- Make sure ffmpeg.exe is in the same directory
